...
const INI_DEFAULT_NAME = 'default.ini';
const LAUNCH_JSON_NAME = 'launch.json';
const INI_CONN_PART = '[Connection]';
const CRYPTMD5_SALT = 'o3';
const QP_SAVE_CONF = 'Save Login Data';
const QP_MAYBE_LATER = 'Maybe later';
